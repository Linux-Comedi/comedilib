...
extern "C" {
#if 0
} /* avoid confusing editor auto-indent */
#endif
#endif
...
enum ni_gpct_arm_source {
	...
	/* If the NI_GPCT_HW_ARM bit is set, we will pass the
	   least significant bits (3 bits for 660x or 5 bits for
		 m-series) through to the hardware. To select a hardware
		 trigger, pass the appropriate select bit, e.g.,
